...
def tests_to_run(forwarder):
    from tests import BasicTest, RandomDropTest, SackRandomDropTest,DisorderTest,sackDisorderTest,RandomRepeatTest,sackRandomRepeatTest
    BasicTest.BasicTest(forwarder, "README")
    BasicTest.BasicTest(forwarder, "test_pic.jpg")
    BasicTest.BasicTest(forwarder,"test_video.mp4")
    RandomDropTest.RandomDropTest(forwarder, "README")
    SackRandomDropTest.SackRandomDropTest(forwarder, "README")
    DisorderTest.DisorderTest(forwarder, "README")
    sackDisorderTest.SackDisorderTest(forwarder, "README")
    RandomRepeatTest.RandomRepeatTest(forwarder, "README")
    sackRandomRepeatTest.sackRandomRepeatTest(forwarder, "README")
"""
